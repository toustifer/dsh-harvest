...
const TAVILY_RESEARCH_ENDPOINT = process.env.TAVILY_RESEARCH_ENDPOINT || 'https://api.tavily.com/research'
    ...
    defineTool({
      ...
      async execute(args) {
        ...
        while (Date.now() - start < timeoutMs) {
          ...
          const pollRes = await fetch(`${TAVILY_RESEARCH_ENDPOINT}/${requestId}`, {
            headers: {
              'Authorization': `Bearer ${TAVILY_KEY}`,
            },
          })
